    ...
    <div class="app-main-content flex-grow-1 bg-light page-shell">
        <nav class="navbar navbar-light bg-white shadow-sm px-4 py-3">
            <div class="container-fluid">
                <div>
                    <span class="navbar-brand mb-0 h1 fw-bold text-primary">Horarios</span>
                    <div class="text-muted">Define los días y horas de cada asignación maestro-grupo-materia.</div>
                </div>
            ...
            <div class="card shadow border-0 mb-3">
                <div class="card-body py-3">
                    <form class="row g-2 align-items-center" method="GET">
                        ...
                        <div class="col-12 col-md-5"><input type="text" name="q" class="form-control" placeholder="Grupo, materia, maestro, día o aula" value="<?php echo htmlspecialchars($search ?? ''); ?>"></div>
                        <div class="col-12 col-md-auto d-grid"><button class="btn btn-primary" type="submit"><i class="bi bi-search"></i> Filtrar</button></div>
                    </form>
                </div>
            </div>
                            ...
                            <?php if (!empty($items)): ?>
                                <?php foreach ($items as $item): ?>
                                    <tr class="<?php echo ((int)($item['activo'] ?? 1) === 0) ? 'table-inactive' : ''; ?>">
                                        <td class="ps-3"><?php echo ((int)($item['activo'] ?? 1) === 1) ? '<span class="badge bg-success">ACTIVO</span>' : '<span class="badge bg-danger">INACTIVO</span>'; ?></td>
                                ...
                                <?php endforeach; ?>
                            <?php else: ?>
                                <tr><td colspan="9" class="text-center p-5 text-muted">No hay horarios registrados.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
