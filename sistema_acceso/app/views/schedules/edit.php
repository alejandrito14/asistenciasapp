    ...
    <div class="app-main-content flex-grow-1 bg-light page-shell">
        <nav class="navbar navbar-light bg-white shadow-sm px-4 py-3">
            <div class="container-fluid">
                <div>
                    <span class="navbar-brand mb-0 h1 fw-bold text-primary">Editar Horario</span>
                    <div class="text-muted">Actualiza los datos de la asignación maestro-grupo-materia.</div>
                </div>
                <a href="?c=Schedule" class="btn btn-outline-secondary"><i class="bi bi-arrow-left"></i> Volver</a>
            </div>
        </nav>
