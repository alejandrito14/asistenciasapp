    ...
    <div class="app-main-content flex-grow-1 bg-light page-shell">
        <nav class="navbar navbar-light bg-white shadow-sm px-4 py-3">
            <div class="container-fluid">
                <div>
                    <span class="navbar-brand mb-0 h1 fw-bold text-primary">Grupos</span>
                    <div class="text-muted">Administra la estructura académica antes de capturar asistencias.</div>
                </div>
                ...
                <div class="card-body py-3">
                    <form class="row g-2 align-items-center" method="GET" action="">
                        ...
                        <div class="col-12 col-md-6">
                            <input type="text" name="q" class="form-control" placeholder="Nombre, semestre o ciclo escolar" value="<?php echo htmlspecialchars($search ?? ''); ?>">
                        </div>
                        ...
                        <tbody>
                            <?php if (!empty($groups)): ?>
                                <?php foreach ($groups as $group): ?>
                                    <tr>
                                        <td class="fw-bold ps-3"><?php echo htmlspecialchars($group['nombre']); ?></td>
