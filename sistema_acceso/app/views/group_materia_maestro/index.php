    ...
    <div class="app-main-content flex-grow-1 bg-light page-shell">
        <nav class="navbar navbar-light bg-white shadow-sm px-4 py-3">
            <div class="container-fluid">
                <div>
                    <span class="navbar-brand mb-0 h1 fw-bold text-primary">Asignación Maestro</span>
                    <div class="text-muted">Vincula un maestro con una materia de un grupo.</div>
                </div>
            ...
            <div class="card shadow border-0 mb-3">
                <div class="card-body py-3">
                    <form class="row g-2 align-items-center" method="GET">
                        ...
                        <div class="col-12 col-md-5"><input type="text" name="q" class="form-control" placeholder="Grupo, materia o maestro" value="<?php echo htmlspecialchars($search ?? ''); ?>"></div>
