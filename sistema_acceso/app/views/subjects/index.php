    ...
    <div class="app-main-content flex-grow-1 bg-light page-shell">
        <nav class="navbar navbar-light bg-white shadow-sm px-4 py-3">
            <div class="container-fluid">
                <div>
                    <span class="navbar-brand mb-0 h1 fw-bold text-primary">Materias</span>
                    <div class="text-muted">Administra el catálogo académico de asignaturas.</div>
                </div>
                ...
                <div class="card-body py-3">
                    <form class="row g-2 align-items-center" method="GET" action="">
                        ...
                        <div class="col-12 col-md-5">
                            <input type="text" name="q" class="form-control" placeholder="Clave, nombre o descripción" value="<?php echo htmlspecialchars($search ?? ''); ?>">
                        </div>
                            ...
                            <?php if (!empty($subjects)): ?>
                                <?php foreach ($subjects as $subject): ?>
                                    <tr class="<?php echo ((int)($subject['activo'] ?? 1) === 0) ? 'table-secondary' : ''; ?>">
                                        <td class="ps-3"><?php echo ((int)($subject['activo'] ?? 1) === 1) ? '<span class="badge bg-success">ACTIVO</span>' : '<span class="badge bg-danger">INACTIVO</span>'; ?></td>
